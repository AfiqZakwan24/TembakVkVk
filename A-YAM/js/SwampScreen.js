...
SwampScreen.prototype.init = function() {
	...
	this.gui.background = new BipMap();
	this.gui.background.set({
		image : game.sprites,
		spriteX : 352,
		spriteY : 181,
		spriteWidth : 256,
...
SwampScreen.prototype.start = function() {
	...
	this.gui.sky.color = '#3763ae'; // Reset the sky's color
	...
	game.layerManager.addToTop('swamp.background', this.gui.background);
